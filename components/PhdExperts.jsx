...
const PhdExperts = () => {
  return (
    <div className="container py-12 relative mx-auto px-1 lg:px-8 flex flex-col justify-between items-center">
      <h2 className="heading  text-center">
        ...
        <div className="my-10 flex lg:flex-row flex-col justify-center items-center">
          ...
          <p className="content">
            ...
            academic report that will obtain you the grades you desire. The best
            writers prepare our reports in the field, and our in-house experts
            will assist you at every step of the way to ensure you receive the
            most value from your report!
          </p>
          </div>
        </div>
        <div className="my-4 flex lg:flex-row flex-col justify-center items-center">
          ...
          <div>
            <h2 className="sub-heading">Why choose our report writing help service?</h2>
            <p className="content">
              When students are given the task of writing a report, it may
              appear to them to be one of the simplest academic tasks ever.
              However, until they sit down to work on it, they understand how
